  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-200 overflow-hidden">
      ...
      {!isDeclined && (
        ...
        >
          <div className="flex size-11 shrink-0 items-center justify-center rounded-full bg-[#3581f3]/10">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-[#3581f3]">
        ...
        <div className="border-t border-gray-100 px-5 pt-5 pb-6 flex flex-col gap-5">
          ...
          {selectedDate && selectedTime && (
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full rounded-xl border border-gray-200 bg-gray-50 px-3 py-3 text-sm text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3581f3]/30 resize-none"
              />
            </div>
          )}
          ...
          {selectedDate && selectedTime && (
            <div className="flex flex-col gap-3">
              <div className="bg-[#3581f3]/5 rounded-2xl p-4">
                <p className="text-xs font-bold uppercase tracking-wider text-[#3581f3] mb-1">Your Request</p>
              ...
              <button
                ...
                disabled={submitting}
                className="w-full py-4 rounded-2xl bg-[#3581f3] text-white font-extrabold text-sm hover:bg-[#3581f3]/90 disabled:opacity-50 active:scale-[0.98] transition-all shadow-lg shadow-[#3581f3]/20"
              >
