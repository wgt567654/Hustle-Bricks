    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-3 px-8 text-center">
        ...
        <button
          ...
          className="mt-2 rounded-xl font-bold py-3 px-6 text-sm bg-[#3581f3] text-white shadow-md shadow-[#3581f3]/30 hover:bg-[#3581f3]/90 active:scale-95 transition-all"
        >
          Go to Services →
        </button>
      </div>
      ...
      <section>
        ...
        {selectedClient ? (
          <div
            ...
            className="flex items-center justify-between p-4 rounded-2xl border border-[#3581f3]/40 bg-[#3581f3]/5 cursor-pointer"
          >
            <div className="flex items-center gap-3">
              <div className="flex size-10 items-center justify-center rounded-full bg-[#3581f3]/15 text-[#3581f3] font-extrabold text-sm">
                  ...
                  return (
                    <div
                      ...
                      className={`flex flex-col p-4 rounded-2xl border shadow-sm active:scale-95 transition-all cursor-pointer ${
                        inCart
                          ? "border-[#3581f3] bg-[#3581f3]/5"
                          : "border-border bg-card hover:border-[#3581f3]/50"
                      }`}
                    >
                      {inCart && (
                        <div className="w-5 h-5 rounded-full bg-[#3581f3] text-white text-[10px] font-bold flex items-center justify-center mb-1.5 self-end">
                          {inCart.qty}
                        </div>
                      )}
                      <span className="font-bold text-sm leading-tight mb-1">{service.name}</span>
                      <span className="text-sm font-extrabold text-[#3581f3] mt-auto">
      ...
      <section className="mt-2 bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full transition-colors ${
                  applyTax ? "bg-[#3581f3]/10 text-[#3581f3]" : "bg-muted text-muted-foreground"
                }`}
              >
                {applyTax ? "ON" : "OFF"}
              </button>
        ...
        <div className="bg-muted p-4 border-t border-border flex gap-3">
          ...
          <button
            ...
            disabled={saving}
            className="flex-1 rounded-xl font-bold py-3 px-4 bg-[#3581f3] text-white shadow-[#3581f3]/30 shadow-lg hover:opacity-90 transition-opacity active:scale-[0.98] disabled:opacity-50"
          >
              ...
              {filteredClients.map((client) => (
                <button
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl text-left transition-colors hover:bg-muted ${
                    selectedClientId === client.id ? "bg-[#3581f3]/10" : ""
                  }`}
                >
                  <div className="flex size-10 items-center justify-center rounded-full bg-[#3581f3]/10 text-[#3581f3] font-extrabold text-sm shrink-0">
                  ...
                  {selectedClientId === client.id && (
                    <span className="material-symbols-outlined text-[20px] text-[#3581f3] ml-auto">check_circle</span>
                  )}
                </button>
              ))}
            </div>
