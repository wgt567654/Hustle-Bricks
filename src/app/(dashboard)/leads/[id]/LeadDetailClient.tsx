...
export default function LeadDetailClient({
  ...
  const [form, setForm] = useState<Partial<Lead>>({
    ...
    phone_alt: initialLead.phone_alt,
    email: initialLead.email,
    address: initialLead.address,
    stage: initialLead.stage,
    estimated_value: initialLead.estimated_value,
    rapport_notes: initialLead.rapport_notes,
    service_notes: initialLead.service_notes,
    preferred_date: initialLead.preferred_date,
    preferred_time: initialLead.preferred_time,
  });
  ...
  const [schedDate, setSchedDate] = useState(initialLead.preferred_date ?? "");
  ...
  const [scoreData, setScoreData] = useState<{
    ...
    initialLead.ai_score != null && initialLead.ai_score_label
      ? {
          score: initialLead.ai_score,
          label: initialLead.ai_score_label,
          reason: initialLead.ai_score_reason ?? "",
          actions: initialLead.ai_score_actions ?? [],
        }
      : null
  );
